( function( savvyPanel ) {
    ...
    control.checkIsRequired = function ( notifications ) {
        ...
        var password_fields = document.querySelectorAll( '.control-field.password' );
        ...
        if ( password_fields.length > 0 ) {
            for ( var i = 0; i < password_fields.length; i++ ) {
                ...
                if ( controlwrapper.querySelector( 'input[type=password]' ).value !== '' ) continue;
    ...
    control.checkPattern = function(notifications ) {
        var new_notifications = [];
        var fields = document.querySelectorAll( '.control-field.password' );
